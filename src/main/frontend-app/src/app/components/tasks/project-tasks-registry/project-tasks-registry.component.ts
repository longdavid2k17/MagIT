...
@Component({
  selector: 'app-project-tasks-registry',
  templateUrl: './project-tasks-registry.component.html',
  styleUrls: ['./project-tasks-registry.component.css']
})
export class ProjectTasksRegistryComponent implements OnInit,AfterViewInit {
  ...
  constructor(public dialogRef: MatDialogRef<ProjectTasksRegistryComponent>,
  ...
  getData(request:any){
    this.isLoading=true;
    this.tasksService.getByProjectIdPageable(this.projectId,request).subscribe(res => {
        // @ts-ignore
